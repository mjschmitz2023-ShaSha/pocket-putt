...
// Multiplayer uses multi-room relay protocol (create/join room codes) on same origin
// (Render or local npm start). Optional ?relay=… and ?room=CODE.
...
// snapshots, so Wi-Fi packet jitter never shows up as ball stutter.
